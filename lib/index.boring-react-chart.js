...
const BoringChart = (props) => {
    const { columnDetails, xData, yData, rootSelector = 'root', canvasSelector = 'canvas', tooltipSelector = '[data-el="tooltip"]', } = props;
    React.useEffect(() => {
...
export { BoringChart };
//# sourceMappingURL=index.boring-react-chart.js.map
